        ...
        <div class="details">
          <div class="recent">
            <div class="cardheader">
              <h2>My Reservations <a class="drop-btn" style="background-color: rgb(5, 187, 5); color: rgb(245, 245, 245); text-decoration: none; right: 3vh;
                position: absolute;" href="../html/Userflights.html">Book Now</a></h2>
            </div>
